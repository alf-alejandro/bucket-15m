"""
dashboard.py — Flask server para Polymarket Bucket-15M Bot.
Rutas:
...
<header>
  <div>
    <div class="logo">BUCKET-15M // <em>LIVE</em></div>
    <div class="logo-sub">ETH · SOL · BTC &mdash; Polymarket 15m Binary</div>
  </div>
