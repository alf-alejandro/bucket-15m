...
LOGICA BINARIA CORRECTA:
  ...
  Cada entrada cuesta exactamente $2.00 (el 2% del capital de $100).
  Shares comprados = $2.00 / precio_ask
...
BUCKET-15M:
  - Mercados UP/DOWN 15m (SLOT_STEP=900)
  - Sizing: 2% del capital por entrada ($2.00 en $100), máx 4%
"""
...
ENTRY_USD            = CAPITAL_TOTAL * ENTRY_PCT   # $2.00
